...
EMCC_OPTS=-O3 --llvm-lto 1 -s NO_FILESYSTEM=1 --memory-init-file 0 -s EXPORTED_RUNTIME_METHODS="['setValue', 'getValue']" -s EXPORTED_FUNCTIONS="['_malloc', '_opus_strerror', '_opus_encoder_create', '_opus_encoder_ctl', '_opus_encoder_destroy', '_opus_decoder_create', '_opus_decoder_ctl', '_opus_decoder_destroy']"
...
compile:
	...
	cp -f src/Opus.js build/Opus.js
